...
| tax | screen | partial | `src/features/tax` — one member's equity capital gains for a tax year: netting, the ₹1.25 lakh allowance, tax at the equity rates, the sales listed by lot with the reason for any not netted, and the allowance still unused. Not built: the regime comparison and computation table, salary and deductions, slabs, surcharge and cess, gains on other asset classes, carried-forward losses, the holding-period clock, advance tax. See Departures |
